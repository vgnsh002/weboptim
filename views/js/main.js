...
var pizzasDiv = document.getElementById("randomPizzas"); //declaration has been taken outside the loop
for (var i = 2; i < 20; i++) {
...
function updatePositions() {
    ...
    //the following declaration has been taken outside the loop to neglect redundancy
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    //the value of i is limited to 20 from 200
    for (var i = 0; i < 20; i++) {
